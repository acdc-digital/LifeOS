...
// /Users/matthewsimon/Projects/LifeOS/LifeOS/lib/store/editor.ts
...
interface Tab {
  id: string;
  title: string;
  type: 'file' | 'welcome' | 'settings' | 'subscription' | 'user-profile' | 'calendar' | 'books';
  filePath?: string;
  isDirty: boolean;
  isPinned: boolean;
}
